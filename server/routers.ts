...
function productValues(input: { name: string; description: string; deliveryFormat: string; priceUsd: number; inventoryText: string; deliveryMode: "automatic" | "manual"; warrantyDays: number; imageUrl: string; freeEligible: boolean; freeWindowMs: number | null; referralEligible: boolean; referralPriceCredits: number; active?: boolean }) {
