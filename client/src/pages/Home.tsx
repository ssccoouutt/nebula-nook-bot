...
import { LayoutDashboard, Package, Settings2, Users, ShoppingBag, LifeBuoy, Send, Plus, Trash2, Radio, Pencil } from "lucide-react";
...
export default function Home() {
  ...
  const welcome = useMemo(() => "Nebula Nook operations.", []);
